...
(function( $, window, document, undefined ) {
	 ...
	 * These methods can be used by extension MadeIns to save the duplication of
	 * code.
	 *
	 *  @namespace
	 */
	...
	DataTable.defaults = {
		 ...
		 * plug-in MadeIns, you should use the `stateLoadParams` event to load parameters for
		 * a plug-in.
		 *  @type function
		 *  @param {object} settings DataTables settings object
		 ...
		 * other state properties or modification. Note that for plug-in MadeIns, you should
