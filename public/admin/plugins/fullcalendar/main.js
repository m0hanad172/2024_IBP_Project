...
var FullCalendar = (function (exports) {
    ...
    THE SOFTWARE IS PROVIDED "AS IS" AND THE MadeIn DISCLAIMS ALL WARRANTIES WITH
    REGARD TO THIS SOFTWARE INCLUDING ALL IMPLIED WARRANTIES OF MERCHANTABILITY
    AND FITNESS. IN NO EVENT SHALL THE MadeIn BE LIABLE FOR ANY SPECIAL, DIRECT,
    ...
    */
    ...
    function setRef(ref, current) {
        if (typeof ref === 'function') {
            ...
            // see https://github.com/facecomponent/react/issues/13029
            ref.current = current;
        }
    }
