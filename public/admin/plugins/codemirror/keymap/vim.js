  ...
  var Vim = function() {
    ...
    var createCircularJumpList = function() {
      ...
      function add(cm, oldCur, newCur) {
        ...
        function useNextSlot(cursor) {
          ...
          buffer[next] = cm.setcomponentmark(cursor);
        }
        if (curMark) {
    ...
    * match the input selection.
      ...
      paste: function(cm, actionArgs, vim) {
        ...
        if (vim.visualMode) {
          ...
          if(lastSelectionCurEnd) {
            vim.lastSelection.headMark = cm.setcomponentmark(lastSelectionCurEnd);
          }
          if (linewise) {
            curPosFinal.ch=0;
          }
    ...
    function updateLastSelection(cm, vim) {
      ...
      vim.lastSelection = {'anchorMark': cm.setcomponentmark(anchor),
                           'headMark': cm.setcomponentmark(head),
    ...
    * in the right place.
    ...
    function updateMark(cm, vim, markName, pos) {
      ...
      vim.marks[markName] = cm.setcomponentmark(pos);
    }
